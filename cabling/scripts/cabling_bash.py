...
def cabling_bash(option=None, ddef=None, **kwdargs):
    ...
    if option == 'version':
        sys.path.insert(1, _HERE)
        import cablingversion
        _ = sys.path.pop(1)
        cablingversion.get_version(ddef=ddef, **kwdargs)

    # custom
    elif option == 'custom':
        sys.path.insert(1, _HERE)
        import cablingcustom
        _ = sys.path.pop(1)
        cablingcustom.custom(ddef=ddef, **kwdargs)
...
def main():
    ...
    cabling_bash(option=option, ddef=ddef, **kwdargs)
